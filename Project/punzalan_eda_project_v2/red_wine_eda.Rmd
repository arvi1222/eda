...
This is a strange distribution.
...
Now, we get a clear picture here of the linear relationship between sulphates and quality. 

In the univariate section, we noticed some outliers in for volatile acid. Let's take a quick look into the wines that had volatile acidity levels higher than 1.
...
The strongest relationship I found was the positive correlation between alcohol and quality mean. I am interested to see how this relationship changes in the next section when alcohol is compared to quality at different levels of acidity and sugar. 
...
###Description Two
Graphing citric acid against average quality ratings did not provide a linear graph. Creating a density of citric acid at each quality level allows one to see that higher citric acid levels correlated to higher quality scores. You can see that low quality wines were most concentrated at less than 0.25 g/dm^3. Middle quality wines were varied, but still concentrated less than 0.4. High quality wines peaked near 0.5 g/dm^3.
