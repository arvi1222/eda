...
I want to focus on which factors most affect quality. The variables that correlate most with quality are alcohol, sulphates, and volatile acidity. Quality has a moderate correlation with alcohol and a weak correlation with sulphates, volatile acidity, and citric acid. Let's see if the graphs reflect this.
